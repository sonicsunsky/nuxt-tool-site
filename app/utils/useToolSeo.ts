...
// ✅ 全局路由规则
const SITE_URL = "https://nuxt-tool-site.vercel.app"; // TODO: 修改为你自己的主域名

// ✅ 工具 SEO 配置表（中文 + 英文）
export const toolsSeoMap: Record<string, ToolSeoItem> = {
  "json-formatter": {
    zh: {
      ...
      canonical: "https://nuxt-tool-site.vercel.app/tools/json-formatter",
    },
    en: {
      ...
      canonical: "https://nuxt-tool-site.vercel.app/en/tools/json-formatter",
    },
  },
  ...
  base64: {
    zh: {
      ...
      canonical: "https://nuxt-tool-site.vercel.app/tools/base64",
    },
    en: {
      ...
      canonical: "https://nuxt-tool-site.vercel.app/en/tools/base64",
    },
  },
  ...
  "regex-tester": {
    zh: {
      ...
      canonical: "https://nuxt-tool-site.vercel.app/tools/regex-tester",
    },
    en: {
      ...
      canonical: "https://nuxt-tool-site.vercel.app/en/tools/regex-tester",
    },
  },
  ...
  "jwt-parser": {
    zh: {
      ...
      description: "在线 JWT 解析与验证工具，不上传数据、确保本地解码更安全。",
      keywords: "JWT 解码,Token 解析,鉴权工具",
      ogTitle: "JWT 在线解析器",
      ogDescription: "解码 JWT Token 并查看 Payload。",
      canonical: "https://nuxt-tool-site.vercel.app/tools/jwt-parser",
    },
    en: {
      ...
      canonical: "https://nuxt-tool-site.vercel.app/en/tools/jwt-parser",
    },
  },
  ...
  timestamp: {
    zh: {
      ...
      canonical: "https://nuxt-tool-site.vercel.app/tools/timestamp",
    },
    en: {
      ...
      canonical: "https://nuxt-tool-site.vercel.app/en/tools/timestamp",
    },
  },
  ...
  uuid: {
    zh: {
      ...
      canonical: "https://nuxt-tool-site.vercel.app/tools/uuid",
    },
    en: {
      ...
      canonical: "https://nuxt-tool-site.vercel.app/en/tools/uuid",
    },
  },
  ...
  "mock-generator": {
    zh: {
      ...
      canonical: "https://nuxt-tool-site.vercel.app/tools/mock-generator",
    },
    en: {
      ...
      canonical: "https://nuxt-tool-site.vercel.app/en/tools/mock-generator",
    },
  },
  ...
  "icon-browser": {
    zh: {
      ...
      canonical: "https://nuxt-tool-site.vercel.app/tools/icon-browser",
    },
    en: {
      ...
      canonical: "https://nuxt-tool-site.vercel.app/en/tools/icon-browser",
    },
  },
  ...
  "curl-builder": {
    zh: {
      ...
      canonical: "https://nuxt-tool-site.vercel.app/tools/curl-builder",
    },
    en: {
      ...
      canonical: "https://nuxt-tool-site.vercel.app/en/tools/curl-builder",
    },
  },
  ...
  "qr-generator": {
    zh: {
      ...
      canonical: "https://nuxt-tool-site.vercel.app/tools/qr-generator",
    },
    en: {
      ...
      canonical: "https://nuxt-tool-site.vercel.app/en/tools/qr-generator",
    },
  },
  ...
  "color-converter": {
    zh: {
      ...
      canonical: "https://nuxt-tool-site.vercel.app/tools/color-converter",
    },
    en: {
      ...
      canonical: "https://nuxt-tool-site.vercel.app/en/tools/color-converter",
    },
  },
  ...
  "password-generator": {
    zh: {
      ...
      description: "在线随机密码生成工具，自定义长度、字符集与强度，安全可靠。",
      keywords: "密码生成器,在线密码,安全随机密码",
      ogTitle: "密码生成器",
      ogDescription: "生成强安全等级密码。",
      canonical: "https://nuxt-tool-site.vercel.app/tools/password-generator",
    },
    en: {
      ...
      canonical:
        "https://nuxt-tool-site.vercel.app/en/tools/password-generator",
    },
  },
  ...
  urlcode: {
    zh: {
      ...
      canonical: "https://nuxt-tool-site.vercel.app/tools/urlcode",
    },
    en: {
      ...
      canonical: "https://nuxt-tool-site.vercel.app/en/tools/urlcode",
    },
  },
  ...
  diff: {
    zh: {
      ...
      canonical: "https://nuxt-tool-site.vercel.app/tools/diff",
    },
    en: {
      ...
      canonical: "https://nuxt-tool-site.vercel.app/en/tools/diff",
    },
  },
};
...
export const useToolSeo = () => {
  ...
  const lang = route.fullPath.includes("/en") ? "en" : "zh";
  const conf = toolsSeoMap[path]?.[lang];

  if (!conf) return; // 没匹配的自动忽略
  ...
  useHead({
    title: conf.title,
    meta: [
      { name: "description", content: conf.desc },
      { name: "keywords", content: conf.keywords },
      { property: "og:title", content: conf.title },
      { property: "og:description", content: conf.desc },
